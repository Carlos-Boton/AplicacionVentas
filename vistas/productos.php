            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border pt-3">
                        <h2 class="box-title">PRODUCTO  <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button>
                        </h2>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form action="" name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                ...
                                <select name="idcategoria" id="idcategoria" class="form-control " data-Live-search="true" required>
                                    <option value="">Selecciona una categoría</option>
                                </select>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                <label for="">Precio</label>
                                <input class="form-control" type="text" name="descripcion" id="descripcion" maxlength="256" placeholder="Precio" required>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                <div id="print">
                                    <svg id="barcode"></svg>
